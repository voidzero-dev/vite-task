...
Add a new entry to `CHANGELOG.md` under the `## Unreleased` section for the change being made in the current branch.
...
5. Append the new entry at the end of the `## Unreleased` section.
