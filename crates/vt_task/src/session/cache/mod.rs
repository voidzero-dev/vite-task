...
use vt_str::Str;
use vt_task_graph::config::ResolvedGlobConfig;
use vt_task_plan::cache_metadata::{CacheMetadata, ExecutionCacheKey, SpawnFingerprint};
use wincode::{
...
pub fn cache_schema_dir_name() -> Str {
    vt_str::format!("v{CACHE_SCHEMA_VERSION}")
}
