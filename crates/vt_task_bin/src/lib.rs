...
impl vt_task::CommandHandler for CommandHandler {
...
#[async_trait::async_trait(?Send)]
impl vt_task::loader::UserConfigLoader for JsonUserConfigLoader {
    async fn load_user_config_file(
        &self,
        package_path: &AbsolutePath,
    ) -> anyhow::Result<Option<vt_task::config::UserRunConfig>> {
        ...
        let user_config: vt_task::config::UserRunConfig =
