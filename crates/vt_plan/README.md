...
`vt_plan` sits between [`vt_graph`](../vt_graph) (which defines what tasks exist and their dependencies) and the actual task executor. It resolves all the runtime details needed to execute tasks:
