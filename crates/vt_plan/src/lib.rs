...
///
/// Unlike tasks in `vt_graph`, this struct contains all information needed for execution,
...
pub trait PlanRequestParser: Debug {
    ...
    ///
    /// `vt_plan` doesn't have the knowledge of how cli args should be parsed. It relies on this callback.
    ///
